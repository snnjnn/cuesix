...
func TestApplyReplacesFileAndReloads(t *testing.T) {
	...
	if err := rel.Apply(context.Background(), testutil.Logger(), []byte("new"), true); err != nil {
...
func TestApplyRejectsMissingConfig(t *testing.T) {
	...
	if err := rel.Apply(context.Background(), testutil.Logger(), []byte("payload"), true); err == nil {
...
func TestApplyRejectsEmptyPayload(t *testing.T) {
	...
	if err := rel.Apply(context.Background(), testutil.Logger(), nil, true); err == nil {
